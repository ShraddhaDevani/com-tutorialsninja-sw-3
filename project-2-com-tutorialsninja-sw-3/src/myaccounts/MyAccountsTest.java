...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        ...
        //3.5 Enter Email
        sendTextToElement(By.id("input-email"), "Nishitpatel31@gmail.com");

        //3.6 Enter Telephone
        sendTextToElement(By.id("input-telephone"), "07845696345");

        //3.7 Enter Password
        sendTextToElement(By.id("input-password"), "nishit_5679");

        //3.8 Enter Password Confirm
        sendTextToElement(By.id("input-confirm"), "nishit_5679");
